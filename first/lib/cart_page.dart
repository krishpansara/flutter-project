            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(product.productName, style:TextStyle(fontSize: 30, overflow: TextOverflow.ellipsis), maxLines: 1,),
                    Text(product.description, style:TextStyle(fontSize: 15),  maxLines: 1,),
                  ],
                ),
              ),
